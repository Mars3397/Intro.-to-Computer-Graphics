...
int main()
{
	...
	// disk
	glm::mat4 disk_model = glm::translate(base_model, glm::vec3(0, 1.3, 0));
	// teapot disk
	glm::mat4 teapotDisk_model = glm::translate(base_model, glm::vec3(-1, 1.5, 0));
	// teapot
	glm::mat4 teapot_model = teapotDisk_model;
	// cat
	glm::mat4 cat_model = glm::translate(disk_model, glm::vec3(2.5, 0, 0));
	// ball
	glm::mat4 ball_model = glm::translate(cat_model, glm::vec3(0, 0.5, 2));
	// identity
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		teapotDisk_model = glm::rotate(identity, glm::radians(-0.2f), glm::vec3(0, 1, 0)) * teapotDisk_model;
		...
		// cat
		cat_model = glm::rotate(identity, glm::radians(-0.7f * rotatingSpeed), glm::vec3(0, 1, 0)) * cat_model;
		DrawModel("cat", cat_model, view, perspective);
		// ball
		ball_model = glm::rotate(ball_model, glm::radians(1.2f), glm::vec3(1, 0, 0));
		ball_model = glm::rotate(identity, glm::radians(-0.7f * rotatingSpeed), glm::vec3(0, 1, 0)) * ball_model;
